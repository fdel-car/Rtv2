...
t_obj	*add_object_dir(t_obj *obj)
{
	...
	obj->dir.x = atof(gtk_entry_get_text(dirx));
	obj->dir.y = atof(gtk_entry_get_text(diry));
	obj->dir.z = atof(gtk_entry_get_text(dirz));
...
t_obj	*add_object_norm(t_obj *obj)
{
	...
	obj->norm.x = atof(gtk_entry_get_text(normx));
	obj->norm.y = atof(gtk_entry_get_text(normy));
	obj->norm.z = atof(gtk_entry_get_text(normz));
...
t_obj	*add_object_rayon(t_obj *obj)
{
	...
	obj->rayon = atof(gtk_entry_get_text(rayon));
	return (obj);
}
...
t_obj	*add_object_alpha(t_obj *obj)
{
	...
	obj->alpha = atof(gtk_entry_get_text(alpha)) * M_PI / 180;
	return (obj);
}
...
t_obj	*add_object_mater_shiny(t_obj *obj)
{
	...
	obj->mater.shiny = atof(gtk_entry_get_text(shiny));
	return (obj);
}
